...
try:
    connect = pyodbc.connect(
        r'Driver= {Microsoft Access Driver (*.mdb, *.accdb)}; DBQ=C:\Users\loren\Downloads\Database1.accdb;')
    print("Connected to a Database")

    Inventors = 'Lorenzo Archibald Penaflorida, Amiel Simon Ray Lalas, Conrad Ully Esconde, Erica Christine Belarmino, Frances Helaena Cambel, Gwyneth Cepeda, Jerome Monte, Renz Julius Guico'
